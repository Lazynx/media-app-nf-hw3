...
export const Footer: React.FC = () => {
    return (
        <footer className="bg-white border-t border-black dark:bg-black dark:border-white dark:text-white text-gray-900 px-4 lg:px-6 h-16 flex items-center justify-between shadow-md">
